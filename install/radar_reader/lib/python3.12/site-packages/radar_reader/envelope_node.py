...
class RadarPublisher(Node): 
    def __init__(self): super().__init__('radar_publisher') # Vytvoření publisheru na topic 'radar_data' 
    self.publisher_ = self.create_publisher(Float32MultiArray, 'radar_data', 10) # Inicializace radaru 
    ...
    self.client.start_session() # Nastavení timeru pro periodické čtení dat 
